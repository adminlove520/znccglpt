...
%>
<input type="hidden" id="deleteerror" value="<%=deleteerror%>">

<script type="text/javascript">
    window.onload=function(){
        var deleteerror=document.getElementById('deleteerror').value;
        if (deleteerror==0) {
            alert("删除成功");
            setTimeout("submit()",0);
        }
