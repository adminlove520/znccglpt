    ...
    <div id="body">
        ...
        <div id="left">
            <ul id="menu">
                ...
                <li>
                    <form id="form" action="用户管理">
                        <input type="hidden" name="username" value="<%=username%>">
                        <input type="submit" id="usermanage" value="用户信息">
                    </form>
                    <!-- <a href="/ssm/用户信息?username=<%=username%>">用户信息</a> -->
                </li>
                <li style="background-color: #526C85;">
                    <div id="border"></div>
                    <a href="/ssm/用户增加">用户增加</a>
                </li>
        ...
        <div id="right">
            <div id="adduser">
                ...
                <div id="addinfo">
                    <sf:form action="/ssm/doAddUser" modelAttribute="user">
                        <div id="sss">
                        <div id="formusername">
                            <div id="formtitle">用户名：</div>
                            <div id="formcon">
                                <sf:input type="text" id="username" path="username" required="true"/>
                            </div>
                        </div>
                        <div id="formpassword">
                            <div id="formtitle">用户密码：</div>
                            <div id="formcon">
                                <sf:input type="text" id="password" path="password" required="true"/>
                            </div>
                        </div>
                        <div id="formrealname">
                            <div id="formtitle">真实姓名：</div>
                            <div id="formcon">
                                <sf:input type="text" id="realname" path="realname" required="true"/>
                            </div>
                        </div>
                        <div id="formphonumber">
                            <div id="formtitle">电话号码：</div>
                            <div id="formcon">
                                <sf:input type="text" id="phonumber" path="phonumber" required="true"/>
                            </div>
                        </div>
                        <sf:input type="hidden" path="type" value="1"/>
                        <sf:input type="hidden" path="director" value="<%=username%>"/>
                        </div>
                        <div id="save">
                            <input type="submit" id="savebtn" value="添加">
                        </div>
                    </sf:form>
                </div>
...
<!--             <sf:form action="/ssm/doAddUser" modelAttribute="user">
                用户名：<sf:input type="text" id="username" path="username" required="true"/><br>
                密码：<sf:input type="text" id="password" path="password" required="true"/><br>
                真实姓名：<sf:input type="text" id="realname" path="realname" required="true"/><br>
                手机号码：<sf:input type="text" id="phonumber" path="phonumber" required="true"/><br>
                <sf:input type="hidden" path="type" value="1"/>
                <sf:input type="hidden" path="director" value="<%=username%>"/>
...
<div id="deleteinfo">
                <h2>用户删除</h2>
                    ...
                    <input type="submit" id="savebtn" value="删除">
                    </form>
...
%>
<input type="hidden" id="adderror" value="<%=adderror%>">

<script type="text/javascript">
    window.onload=function(){
        var adderror=document.getElementById('adderror').value;
        if (adderror==0) {
            alert("添加成功");
            setTimeout("submit()",0);
        }
