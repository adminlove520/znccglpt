...
%>
    ...
    <div id="body">
        ...
        <div id="left">
            <ul id="menu">
                <li value="0"><a href="/ssm/inbase1" target="iframe_a">入库管理</a></li>
                <li value="0"><a href="/ssm/outbase1" target="iframe_a">出库管理</a></li>
                <li value="0"><a href="/ssm/select" target="iframe_a">物品查询</a></li>
                <li value="0"><a href="/ssm/sum" target="iframe_a">物品盘点</a></li>
<!--                 <li value="0"><a href="/ssm/move" target="iframe_a">物品移动</a></li> -->
        ...
        <div id="right">
            <iframe src="/ssm/空白" name="iframe_a" width="100%" height="100%" frameborder="0"></iframe>
        </div>
    </div>
</body>
